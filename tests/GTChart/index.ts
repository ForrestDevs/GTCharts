...
import ChartImp, { type GTChart, DomPosition } from './GTChart'
 ...
 * @returns {Chart}
 */
function init (ds: HTMLElement | string, options?: Options): Nullable<GTChart> {
  logTag()
 ...
 * @param dcs
 */
function dispose (dcs: HTMLElement | GTChart | string): void {
